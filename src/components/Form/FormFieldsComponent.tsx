...
export type FormFieldsComponentProps<T extends FormDataType> = {
  errors: FormErrors<T>;
  fields: FormFields<T>;
...
export const FormFieldsComponent = <T extends FormDataType>({ fields, ...props }: FormFieldsComponentProps<T>) => {
